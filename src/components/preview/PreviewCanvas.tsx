      ...
      <div className="absolute right-2 top-2 z-10 flex items-center gap-1.5">
        {onRestart && (
          <button
            type="button"
            onClick={onRestart}
            title="Restart the container (hard reset)"
            aria-label="Restart container"
            className="flex h-6 w-6 items-center justify-center rounded-md border border-zinc-700 bg-zinc-900/90 text-zinc-400 transition-colors hover:bg-zinc-800 hover:text-zinc-100"
          >
            <svg width="12" height="12" viewBox="0 0 16 16" fill="none" aria-hidden="true">
              ...
              <path d="M11.5 14.5l-3-1.5 2.5-2 0.5 3.5Z" fill="currentColor" />
            </svg>
          </button>
        )}
        <button
